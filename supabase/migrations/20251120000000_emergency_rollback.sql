-- EMERGENCY ROLLBACK - Undo all the changes we made
-- This will restore your system to working condition
...
-- 3. Drop the stock_movements table entirely (we'll recreate it safely later)
DROP TABLE IF EXISTS public.stock_movements CASCADE;

-- 4. Drop any problematic policies
...
-- 5. Recreate the original api_create_order function exactly as it was
