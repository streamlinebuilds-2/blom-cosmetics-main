...
('Flower Nail Art Workshop', 'blom-flower-watercolor-workshop', 'Learn how to create soft, dreamy flower nail art designs from the comfort of your home with step-by-step videos and detailed guidance.', 'Create soft, dreamy flower nail art online', 480.00, 0, 'Avané Crous', 'Professional nail artist and educator with over 8 years of experience.', '/online-watercolor-card.webp', 'online', 'beginner', true, true, NOW() + INTERVAL '7 days'),
