...
export const ShopPage: React.FC = () => {
  ...
  const allProducts = [
    ...
    // Coming Soon Products (Prices TBA)
    {
      id: '10',
    ...
    },
    {
      ...
      images: ['/snow-white-acrylic-01.webp'],
      category: 'acrylic-system',
      rating: 4.8,
      reviews: 89,
      badges: ['Coming Soon'],
    ...
    },
    {
      ...
      images: ['/colour-acrylics-01.webp'],
      category: 'acrylic-system',
      rating: 4.7,
      reviews: 73,
      badges: ['Coming Soon'],
    ...
    },
    {
      ...
      images: ['/glitter-acrylics-01.webp'],
      category: 'acrylic-system',
      rating: 4.6,
      reviews: 45,
      badges: ['Coming Soon'],
    ...
    {
      id: '15',
      name: 'Acrylic Sculpture Brush (100% Kolinsky)',
      slug: 'acrylic-sculpture-brush',
      price: -1,
      compareAtPrice: undefined,
