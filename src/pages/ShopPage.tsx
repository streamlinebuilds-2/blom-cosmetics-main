...
export const ShopPage: React.FC = () => {
  ...
  const allProducts = [
    ...
    },
    {
      ...
      images: ['/crystal-clear-acrylic.webp'],
      category: 'acrylic-system',
      rating: 4.9,
      reviews: 156,
      badges: ['Bestseller'],
