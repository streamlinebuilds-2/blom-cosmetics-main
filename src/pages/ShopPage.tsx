  ...
  const allProducts = [
    ...
    },
    {
      ...
      variants: [
        ...
        { name: 'Lilac Mist', inStock: true, image: '/acrylic-powder-baby-ligt-purple.jpg' },
        { name: 'Blush Pink', inStock: true, image: '/acrylic-powder-baby-pink.jpg' },
        { name: 'Ballet Pink', inStock: true, image: '/acrylic-powder-ballet-pink.jpg' },
        { name: 'Fuchsia Pink', inStock: true, image: '/acrylic-powder-hot-pink.jpg' },
        { name: 'Cloud Grey', inStock: true, image: '/acrylic-powder-light-grey.jpg' },
        { name: 'Mint Mist', inStock: true, image: '/acrylic-powder-light-mint.jpg' },
        { name: 'Rose Pink', inStock: true, image: '/acrylic-powder-light-pink.jpg' },
        { name: 'Fresh Mint', inStock: true, image: '/acrylic-powder-mint.jpg' },
        { name: 'Soft Nude', inStock: true, image: '/acrylic-powder-nude.jpg' },
        { name: 'Petal Pink', inStock: true, image: '/acrylic-powder-pink.jpg' },
        { name: 'Sky Blue', inStock: true, image: '/acrylic-powder-sky-blue.jpg' },
        { name: 'Lemon Glow', inStock: true, image: '/acrylic-powder-yellow.jpg' }
      ]
    },
