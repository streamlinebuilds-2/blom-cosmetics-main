    ...
    <div className={variant === 'full' ? 'mt-6 pt-6 border-t border-gray-200' : ''}>
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2">
          {/* PayFast */}
          <img src="https://res.cloudinary.com/dnlgohkcc/image/upload/q_auto/f_auto/v1776237198/Payfast_logo_fsryos.png" alt="PayFast" className="h-7 w-auto object-contain bg-white border border-gray-200 rounded-md px-2 py-1" />
          {/* Payflex BNPL */}
          <img src="https://res.cloudinary.com/dnlgohkcc/image/upload/q_auto/f_auto/v1776237251/a65340aacf8a80f5029d90f502460b539230993ffc89107fa4adbd83800f6d07-Payflex_Logo_-_Navy_v1tbdx.png" alt="Payflex" className="h-9 w-auto object-contain bg-white border border-gray-200 rounded-md px-2 py-1" />
